 ...
 */
public class ChangeTiaoZhengFragment extends BaseFrag {
    ...
    public ChangeTiaoZhengFragment() {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "4", "52", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
