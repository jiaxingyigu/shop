...
public class CollectListAdapter extends RecyclerView.Adapter<CollectListAdapter.ViewHolder> {
    ...
    public CollectListAdapter(Context context, List<MapiItemResult> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        MapiResourceResult mapiResourceResult = itemResult.getImg_info();
        if(null!=mapiResourceResult){
            //创建将要下载的图片的URI
            Uri imageUri = Uri.parse(mapiResourceResult.getUrl());
        ...
        holder.goodsName.setText(mList.get(position).getName());
