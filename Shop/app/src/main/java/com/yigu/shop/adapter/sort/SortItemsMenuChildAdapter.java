 ...
 */
public class SortItemsMenuChildAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SortItemsMenuChildAdapter(Context context, List<IndexData> list) {
