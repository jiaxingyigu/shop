 ...
 */
public class MunityDiPanFragment extends BaseFrag {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "0", "37", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
