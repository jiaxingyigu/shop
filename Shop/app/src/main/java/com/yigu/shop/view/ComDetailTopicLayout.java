 ...
 */
public class ComDetailTopicLayout extends RelativeLayout {
    ...
    public ComDetailTopicLayout(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public ComDetailTopicLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public ComDetailTopicLayout(Context context, AttributeSet attrs, int defStyleAttr) {
