 ...
 */
public class ChangeXuanGuaFragment extends BaseFrag {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "5", "52", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
