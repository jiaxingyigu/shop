 ...
 */
public class PortalSearchAdapter extends RecyclerView.Adapter<PortalSearchAdapter.ViewHolder> {
    ...
    public PortalSearchAdapter(Context context, List<MapiMunityResult> list) {
