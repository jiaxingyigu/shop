...
public class ServiceDetailActivity extends BaseActivity {
    ...
    String topicId = "";
    String boardId = "";
    MapiMunityResult mapiMunityResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != getIntent()) {
            ...
            mapiMunityResult = (MapiMunityResult) getIntent().getSerializableExtra("item");
        }
        ...
        CommunityApi.postlist(this, topicId, boardId, new RequestCallback<JSONObject>() {
            ...
            public void success(JSONObject success) {
                ...
                try {
                    ...
                    mList.add(new IndexData(0, "SERVICE_HEAD", mapiMunityResult));
                    mList.add(new IndexData(1, "ITEM", list));
