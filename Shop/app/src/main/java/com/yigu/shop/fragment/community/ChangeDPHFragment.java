 ...
 */
public class ChangeDPHFragment extends BaseFrag {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "2", "52", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
