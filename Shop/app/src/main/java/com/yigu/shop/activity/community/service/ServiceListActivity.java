package com.yigu.shop.activity.community.service;
...
import com.yigu.shop.adapter.community.service.ServiceListAdapter;
...
public class ServiceListActivity extends BaseActivity {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(this, "0", "57", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
    ...
    private void initListener() {
        ...
        mAdapter.setOnItemClickListener(new RecyOnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ControllerUtil.go2ServiceDetail(mapiMunityResult.getTopic_id(), mapiMunityResult.getBoard_id(),mapiMunityResult);
            }
        });
