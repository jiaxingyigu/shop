...
public class HomeHostLayout extends RelativeLayout {
    ...
    public void load(List<MapiResourceResult> list){
        ...
        layoutParams.setMargins(DPUtil.dip2px(5), DPUtil.dip2px(10), DPUtil.dip2px(5), DPUtil.dip2px(13));
        for(int i=0;i<3;i++){
//            View view = LayoutInflater.from(mContext).inflate(R.layout.layout_index_best_private_recommend_item, null);
