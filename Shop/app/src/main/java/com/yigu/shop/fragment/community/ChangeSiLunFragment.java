 ...
 */
public class ChangeSiLunFragment extends BaseFrag {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "1", "52", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
