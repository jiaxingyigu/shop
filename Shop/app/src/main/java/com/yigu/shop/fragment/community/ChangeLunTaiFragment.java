 ...
 */
public class ChangeLunTaiFragment extends BaseFrag {
    ...
    public void load() {
        ...
        showLoading();
        CommunityApi.topiclist(getActivity(), "3", "52", "all", "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiMunityResult>>() {
            @Override
